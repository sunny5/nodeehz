...
objConfig = JSON.parse(fs.readFileSync('/home/sunny5/nodeehz/grid-config.json', 'utf8'));
...
int1_8_0=0, int2_8_0prev=0, int2_8_0=0, int15_7_0=0;
var chunk = "";
...
serial_port.on("data", function (data) {
   ...
   if (chunk.match(regCompleteMsg)) {
	...
	if (arr2_8_0[1] <= int2_8_0prev) {
           int2_8_0prev = arr2_8_0[1];
        }
        else {
           int2_8_0prev = arr2_8_0[1];
        ...
        console.log("Wirkleistung momentan (15_7_0): " + int15_7_0  + " W");
        console.log("Gesamt Bezug (1_8_0): " + int1_8_0 + " kW");
        console.log("Gesamt Einspeisung (2_8_0): " + int2_8_0 + " kW");
        //console.log(chunk);

        if (conn.JOINEDROOM == true && bolSend == true) {
            conn.send("<message from='"+strGroupchatRoom+"/ehz' id='mymsg' to='"+strGroupchatRoom+"' type='groupchat'><body>e:"+Math.round(int15_7_0)+"</body></message>");
